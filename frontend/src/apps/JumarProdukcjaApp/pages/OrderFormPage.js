      ...
      <div className="order-form-frame">
        <aside className="order-form-side">
          ...
          <div className="order-form-side-actions">
            <button type="button" className="btn btn-outline" onClick={() => navigate('/orders/planning')}>
              Anuluj
            </button>
            {!isEdit && (
              <button
        ...
        <form id="order-form-main" className="order-form-layout" onSubmit={handleSubmit}>
          ...
          <label className="order-field order-required order-span-all">
            <span>Artykuł</span>
            <input
              name="Artykul"
              value={form.Artykul || ''}
              onChange={handleChange}
              placeholder="Produkowana folia"
              required
            />
          </label>

          <div className="order-fields-row order-row-4">
          ...
          <div className="order-fields-row order-row-6">
            <label className="order-field order-required">
              <span>NrWytł</span>
            ...
            <label className="order-field order-optional">
              <span>Kod</span>
          ...
          <div className="order-fields-row order-row-3">
            <label className="order-field order-required">
              <span>SzerWorka [mm]</span>
              <input name="SzerWorka" type="number" value={form.SzerWorka || ''} onChange={handleChange} required />
            </label>
            <label className="order-field order-required">
              <span>SzerRękawa [mm]</span>
              <input name="SzerRekawa" type="number" value={form.SzerRekawa || ''} onChange={handleChange} required />
            </label>
            <label className="order-field order-auto">
              <span>Zakładka [mm]</span>
              <input name="Zakladka" value={form.Zakladka || ''} readOnly />
            </label>
          </div>

          <div className="order-fields-row order-row-3">
            <label className="order-field order-required">
              <span>DługWorka [mm]</span>
              <input
                name="DlugWorka"
                type="number"
                value={form.DlugWorka || ''}
                onChange={handleChange}
                required
              />
            </label>
            <label className="order-field order-required">
              <span>GrubWorka [mikr]</span>
              <input
                name="GrubWorka"
                type="number"
            ...
            <label className="order-field order-optional">
              <span>DługFoilPlan Korekta [mb]</span>
              <input
          ...
          <div className="order-fields-row order-row-2">
            <label className="order-field order-auto">
              <span>WagaFoilZlec [kg]</span>
              <input name="WagaFoliZlec" type="number" value={form.WagaFoliZlec || ''} readOnly />
            </label>
            <label className="order-field order-auto">
              <span>DługFoilPlan [mb]</span>
              <input name="DlugFoliPlan" type="number" value={form.DlugFoliPlan || ''} readOnly />
            </label>
          </div>

          <div className="order-fields-row order-row-2">
            <label className="order-field order-required">
              <span>IlośćRolekZlec [szt]</span>
              <input name="IloscRolekZlec" type="number" value={form.IloscRolekZlec || ''} onChange={handleChange} />
            </label>
            <label className="order-field order-required">
          ...
          <div className="order-fields-row order-row-3">
            <label className="order-field order-auto">
              <span>DługRolkiPlan [mb]</span>
              <input name="DlugRolkiPlan" type="number" value={form.DlugRolkiPlan || ''} readOnly />
            </label>
            <label className="order-field order-auto">
              <span>DługFoilZlec korekta [mb]</span>
              <input name="DlugFoliZlec_Korekta" type="number" value={form.DlugFoliZlec_Korekta || ''} readOnly />
            </label>
            <label className="order-field order-auto">
              <span>WagaRolkiZlec [kg]</span>
              <input name="WagaRolkiZlec" type="number" value={form.WagaRolkiZlec || ''} readOnly />
            </label>
          </div>

          <label className="order-field order-optional order-span-all order-uwagi">
            <span>Uwagi</span>
            <textarea
              name="Uwagi"
              value={form.Uwagi || ''}
            ...
            />
            <small>{(form.Uwagi || '').length}/1024</small>
          </label>
